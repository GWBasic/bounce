...
//use core::any::Any;
/*pub fn bridge<TSocket>(a: TSocket, b: TSocket) where
    TSocket: Read + Write + Clone + Send + Any + Unpin {

    task::spawn(bridge_connections(a.clone(), b.clone()));
    task::spawn(bridge_connections(b, a));
}*/
